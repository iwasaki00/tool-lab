...
export function createSwitch(ctx: ObjectContext, interactions: InteractionManager, events: EventManager, options: { id: string; position: Vector3; eventId: string; emitEvent?: boolean; onMessage: (message: string) => void; onActivate?: () => void }): void {
