...
import type { DiscoverySnapshot } from "./GameTypes";
...
export class DiscoveryManager {
  ...
  constructor(scene: Scene, private readonly camera: Camera, private readonly registry: WorldRegistry, private readonly enabled: boolean, private readonly onDiscovery: (snapshot: DiscoverySnapshot) => void) {
