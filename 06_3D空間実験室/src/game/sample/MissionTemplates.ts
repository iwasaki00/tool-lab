import type { MissionDifficulty, MissionPrerequisites, MissionStep, MissionStepType, MissionType } from "../../gameplay/MissionTypes";
import type { GuideTargetType } from "../../gameplay/ObjectiveManager";
