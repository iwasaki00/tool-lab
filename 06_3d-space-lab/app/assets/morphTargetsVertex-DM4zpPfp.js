import{S as e}from"./index-Cf2wCaLj.js";const t="morphTargetsVertexGlobalDeclaration",d=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=d);const r="morphTargetsVertexDeclaration",i=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);const n="morphTargetsVertexGlobal",T=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=T);const f="morphTargetsVertex",o=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
